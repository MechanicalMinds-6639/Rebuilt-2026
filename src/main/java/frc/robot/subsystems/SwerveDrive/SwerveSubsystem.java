...
public class SwerveSubsystem extends SubsystemBase {
      ...
      AutoBuilder.configure(
          ...
          () -> {
            ...
            if (alliance.isPresent()) {
              return alliance.get() == OperatorConstants.RED_ALLIANCE;
            }
            return false;
          },
          this
  ...
  public static void allianceRelativeGyroscopeControl() {
    Rotation2d offset2d = swerveDrive.getYaw().plus(Rotation2d.fromDegrees(180));
    Rotation3d offset3d = new Rotation3d(0, 0, offset2d.getRadians());

    swerveDrive.setGyroOffset(offset3d);
  }

  // Locks the wheels in an X pattern to prevent movement, also known as "anti-push"
  public Command antiPushWheels() {
    return run(() -> {
